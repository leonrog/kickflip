...
# ---Obstacles for Demo-----------------------------------------
small_ramp =       Obstacle.create!(name: 'Small Ramp',          category: 'Ramp',     price: 10, availability: true, user: dion, description: 'This is my go-to obstacle when trying out new tricks. Can highly recommend this obstacle.',                                                                    location: 'Berlin')
